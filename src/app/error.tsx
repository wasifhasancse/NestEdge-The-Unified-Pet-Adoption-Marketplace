      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="border border-[var(--border)] text-[var(--foreground)] hover:bg-[var(--muted)] flex items-center gap-2 rounded-xl px-5"
          >
            <RefreshCcw size={18} />
            Retry
          </button>

          {/* Alternatively, in Next.js error.tsx you can use:
